...
class WhereOnRelationTest extends TestCase
{
    public function testWhereOnRelationWithOrderByJoin()
    {
        ...
        $queryTest = '/select "sellers".* from "sellers" inner join "locations" on "locations"."seller_id" = "sellers"."id" and "locations"."is_primary" = \? and "locations"."is_secondary" = \? and "locations"."deleted_at" is null order by "locations"."id" desc/';
        ...
        $queryTest = '/select "sellers".* from "sellers" inner join "locations" on "locations"."seller_id" = "sellers"."id" and "locations"."is_primary" = \? and "locations"."deleted_at" is null order by "locations"."id" desc/';
        $this->assertRegExp($queryTest, $this->fetchQuery());

        //locationPrimary have one where ['is_secondary => 1']
        $items = Seller::orderByJoin('locationSecondary.id', 'desc')->get();
        $queryTest = '/select "sellers".* from "sellers" inner join "locations" on "locations"."seller_id" = "sellers"."id" and "locations"."is_secondary" = \? and "locations"."deleted_at" is null order by "locations"."id" desc/';
        $this->assertRegExp($queryTest, $this->fetchQuery());
        ...
        $queryTest = '/select "sellers".* from "sellers" inner join "locations" on "locations"."seller_id" = "sellers"."id" and "locations"."is_primary" = \? or "locations"."is_secondary" = \? and "locations"."deleted_at" is null order by "locations"."id" desc/';
        $this->assertRegExp($queryTest, $this->fetchQuery());
    }
