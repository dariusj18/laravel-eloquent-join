...
class WhereJoinTest extends TestCase
{
    ...
    public function testWhereJoinBelongsTo()
    {
        ...
        $queryTest = '/select "sellers".* from "sellers" inner join "cities" on "cities"."id" = "sellers"."city_id" and "cities"."deleted_at" is null where "cities"."name" = \?/';
        $this->assertRegExp($queryTest, $this->fetchQuery());
    }
    ...
    public function testWhereJoinHasOne()
    {
        ...
        $queryTest = '/select "sellers".* from "sellers" inner join "locations" on "locations"."seller_id" = "sellers"."id" and "locations"."is_primary" = \? and "locations"."deleted_at" is null where "locations"."address" = \?/';
        $this->assertRegExp($queryTest, $this->fetchQuery());
    }
    ...
    public function testWhereJoinBelongsToBelongsTo()
    {
        ...
        $queryTest = '/select "sellers".* from "sellers" inner join "cities" on "cities"."id" = "sellers"."city_id" and "cities"."deleted_at" is null inner join "states" on "states"."id" = "cities"."state_id" and "states"."deleted_at" is null where "states"."name" = \?/';
        $this->assertRegExp($queryTest, $this->fetchQuery());
    }
    ...
    public function testWhereJoinBelongsToHasOne()
    {
        ...
        $queryTest = '/select "sellers".* from "sellers" inner join "cities" on "cities"."id" = "sellers"."city_id" and "cities"."deleted_at" is null inner join "zip_codes" on "zip_codes"."city_id" = "cities"."id" and "zip_codes"."is_primary" = \? and "zip_codes"."deleted_at" is null where "zip_codes"."name" = \?/';
        $this->assertRegExp($queryTest, $this->fetchQuery());
    }
    ...
    public function testWhereJoinHasOneHasOne()
    {
        ...
        $queryTest = '/select "sellers".* from "sellers" inner join "locations" on "locations"."seller_id" = "sellers"."id" and "locations"."is_primary" = \? and "locations"."deleted_at" is null inner join "location_addresses" on "location_addresses"."location_id" = "locations"."id" and "location_addresses"."is_primary" = \? and "location_addresses"."deleted_at" is null where "location_addresses"."name" = \?/';
        $this->assertRegExp($queryTest, $this->fetchQuery());
    }
